...
********************************************/
/*****************************************************************
 * 冒泡的交换实现要比插入繁琐许多，因此实际中用的插入排序较比冒泡使用较多
...
*************************************************************/
bool insertSort(int *arr, int length)
{
 ...
 * 复杂度均为O(n^2)
**********************************************************/
bool selectSort(int *arr, int length)
{
    for(int i = 0; i < length; i++) {
        int min = i;
